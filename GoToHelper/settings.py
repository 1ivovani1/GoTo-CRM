"""
Django settings for GoToHelper project.
...
SECRET_KEY = 'p-7+_$lcsi+q*+=biqe+88kpx9r&4ay3cw#1m3r@_p3&bar-aq'
...
WSGI_APPLICATION = 'GoToHelper.wsgi.application'
